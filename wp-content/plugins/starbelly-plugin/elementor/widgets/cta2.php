			...
			<div class="container">
				<div class="row">
					<div class="col-lg-6 align-self-center">
						<div class="sb-cta-text">
							<# if ( settings.title ) { #>
							<{{{ settings.title_tag }}} class="sb-{{{ settings.title_style }}} sb-title--h sb-mb-15">
					...
					<div class="col-lg-6">
						<div class="sb-illustration-<# if ( settings.image_style == 'reserved' ) { #>8<# } else { #>6<# } #>">
							<# if ( settings.image ) { #>
							<img src="{{{ settings.image.url }}}" alt="img" class="sb-{{{ settings.image_style }}}">
							<# } #>
