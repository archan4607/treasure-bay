...
class Starbelly_Hero_Banner_Widget extends Widget_Base {
    ...
    <!-- banner -->
    <section class="sb-banner">
			<# if ( settings.bg_type == 'rect' ) { #>
			<div class="sb-bg-1">
        <div></div>
      </div>
			<# } #>
			<# if ( settings.bg_type == 'circle' ) { #>
			<div class="sb-bg-2">
				<div></div>
			</div>
			<# } #>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            ...
            <div class="sb-main-title-frame">
              <div class="sb-main-title">
                ...
                <# } #>
                <# if ( settings.title ) { #>
                <{{{ settings.title_tag }}} class="sb-mb-30 sb-el-title">
                ...
                <# _.each( settings.buttons, function( button, index ) {
        		      var button_label = view.getRepeaterSettingKey( 'label', 'buttons', index );
        		    	view.addInlineEditingAttributes( button_label, 'none' );

                  var iconHTML = elementor.helpers.renderIcon( view, button.icon_fa, { 'aria-hidden': true }, 'i' , 'object' );
        			  #>
                  <!-- button -->
                  <a<# if ( button.link ) { #><# if ( button.link.is_external ) { #> target="_blank"<# } #><# if ( button.link.nofollow ) { #> rel="nofollow"<# } #> href="{{{ button.link.url }}}"<# } #> class="sb-btn<# if ( button.transparent == 'yes' ) { #> sb-btn-2<# } #><# if ( button.second == 'yes' ) { #> sb-btn-gray<# } #>">
                    <# if ( button.icon == 'yes' ) { #>
                    <span class="sb-icon">
                      <# if ( button.icon_el == 'yes' ) { #>
                        {{{ iconHTML.value }}}
                      <# } else { #>
                        <img src="{{{ button.icon_file.url }}}" alt="" />
                      <# } #>
                    </span>
                    <# } #>
                    <span {{{ view.getRenderAttributeString( button_label ) }}}>{{{ button.label }}}</span>
                  </a>
                  <!-- button end -->
                <# }); #>
                <# } #>
          ...
          <div class="col-lg-6">
						<# if ( settings.type == 'layout-1' ) { #>
						<# if ( settings.image ) { #>
            <div class="sb-illustration-1">
              <img src="{{{ settings.image.url }}}" alt="" class="sb-girl" />
            ...
            <# } #>
						...
						<# if ( settings.type == 'layout-2' ) { #>
						<div class="sb-ilustration-fix">
							<div class="sb-illustration-1-2">
								<# if ( settings.image2_1 ) { #>
								<img src="{{{ settings.image2_1.url }}}" alt="image" class="sb-food-1" />
								<# } #>
								<# if ( settings.image2_2 ) { #>
								<img src="{{{ settings.image2_2.url }}}" alt="image" class="sb-food-2" />
								<# } #>
								<# if ( settings.image2_3 ) { #>
								<img src="{{{ settings.image2_3.url }}}" alt="image" class="sb-food-3" />
								<# } #>

								<# if ( settings.dialogs == 'yes' ) { #>
								<# if ( settings.dialog_title1 ) { #>
								<div class="sb-illu-dialog-1">
									<# if ( settings.dialog_smile ) { #>
									<span class="smile">
										<span {{{ view.getRenderAttributeString( 'dialog_smile' ) }}}>{{{ settings.dialog_smile }}}</span>
									</span>
									<# } #>
									<span {{{ view.getRenderAttributeString( 'dialog_title1' ) }}}>{{{ settings.dialog_title1 }}}</span>
								</div>
								<# } #>
								<# if ( settings.dialog_title2 ) { #>
								<div class="sb-illu-dialog-2">
									<# if ( settings.dialog_smile2 ) { #>
									<span class="smile">
										<span {{{ view.getRenderAttributeString( 'dialog_smile2' ) }}}>{{{ settings.dialog_smile2 }}}</span>
									</span>
									<# } #>
									<span {{{ view.getRenderAttributeString( 'dialog_title2' ) }}}>{{{ settings.dialog_title2 }}}</span>
								</div>
								<# } #>
								<# } #>
