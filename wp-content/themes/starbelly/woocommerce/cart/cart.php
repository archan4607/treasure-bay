			...
			<div class="row align-items-center">
				<div class="col-lg-6">
					<div class="sb-product">
						...
						<div class="sb-prod-description">
							<?php
							if ( ! $product_permalink ) {
								echo '<h4 class="sb-mb-10">' . wp_kses_post( apply_filters( 'woocommerce_cart_item_name', $_product->get_name(), $cart_item, $cart_item_key ) . '</h4>' );
							} else {
				...
				<div class="col-3 col-lg-1">
					<div class="sb-price-1">
						<span class="label"><?php esc_html_e( 'Price:', 'starbelly' ); ?></span>
						<?php
				...
				<div class="col-3 col-lg-1">
					<div class="sb-price-2">
						<span class="label"><?php esc_html_e( 'Total:', 'starbelly' ); ?></span>
						<?php
